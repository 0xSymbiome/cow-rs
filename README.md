...
cow-sdk@0.1.0-alpha.9` does the same. JavaScript and TypeScript consumers install
the wasm bindings from npm:

```sh
npm install @symbiome-forge/cow-sdk-wasm@0.1.0-alpha.9
```
...
cow-sdk@0.1.0-alpha.9` for Rust, `npm install @symbiome-forge/cow-sdk-wasm@0.1.0-alpha.9`
