...
```toml
[dependencies]
cow-sdk = "0.1.0-alpha.5"
```

`cow-sdk` is in alpha, so the pre-release is pinned explicitly; `cargo add
cow-sdk@0.1.0-alpha.5` does the same. JavaScript and TypeScript consumers install
the wasm bindings from npm:

```sh
npm install @symbiome-forge/cow-sdk-wasm@0.1.0-alpha.5
```
...
cow-sdk@0.1.0-alpha.5` for Rust, `npm install @symbiome-forge/cow-sdk-wasm@0.1.0-alpha.5`
