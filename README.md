...
cow-sdk@0.1.0-alpha.7` does the same. JavaScript and TypeScript consumers install
...
cow-sdk@0.1.0-alpha.7` for Rust, `npm install @symbiome-forge/cow-sdk-wasm@0.1.0-alpha.7`
