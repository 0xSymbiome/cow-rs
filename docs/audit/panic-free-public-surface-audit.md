...
| Panic allowlist | `.github/config/panic-allowlist.yaml` carries 50 reviewed item-path entries covering 59 accepted static-invariant panic-bearing calls | Conforms |
