...
| `crates/core/src/types/identity.rs:63`; `crates/core/src/types/identity.rs:322`; `crates/core/src/types/identity.rs:437`; `crates/core/src/types/identity.rs:561`; `crates/core/src/types/hex.rs:149` | Hex constructors encode bytes through ASCII-only helper functions, and the guarded nibble decoder is called after shape validation. |
