...
| `crates/core/src/transport/policy/config.rs:68`; `crates/core/src/transport/policy/config.rs:89`; `crates/core/src/transport/policy/config.rs:114`; `crates/core/src/transport/policy/config.rs:139` | Default user-agent literals are header-safe crate constants used to build shared transport policies. |
| `crates/core/src/transport/policy/jitter.rs:111`; `crates/core/src/transport/policy/retry.rs:138`; `crates/core/src/transport/policy/time.rs:26`; `crates/trading/src/wait.rs:293`; `crates/trading/src/order.rs:219`; `crates/trading/src/onchain.rs:505` | Values are clamped or statically bounded immediately before conversion, so the fallible conversion documents the invariant rather than accepting caller-controlled overflow. |
