...
| --- | --- | --- |
| Topic identity | On-chain order and settlement event topic-0 values equal the canonical keccak-256 of their flattened-tuple signatures and are byte-locked, so a binding drift breaks the build | Conforms |
