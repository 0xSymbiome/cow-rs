---
type: Guide
title: "cow-rs and the TypeScript SDK"
description: "The canonical SDK for CoW Protocol is @cowprotocol/cow-sdk, a TypeScript monorepo maintained by the protocol team."
...
[`PROPERTIES.md`](../properties/index.md). The point is not that Rust is faster; it is
