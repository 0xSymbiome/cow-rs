...
description: "This document describes how publication ownership for the cow-rs crates on crates.io is managed: how invitations are issued, how maintainers are rotated on and off the owner list, and how a broken release is retracted."
