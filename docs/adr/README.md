...
| [0071](0071-wasm-component-distribution-channel.md) | Proposed (deferred) | Plan a WebAssembly Component distribution channel as a deferred additive leaf crate (not yet rooted), parallel to the wasm-bindgen npm lane and distributed through OCI. |
