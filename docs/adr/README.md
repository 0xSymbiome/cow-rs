...
| [0014](0014-eip1271-verification-cache.md) | Accepted (amended) | Thread a pluggable `Eip1271VerificationCache` through `verify_eip1271_signature_async` and cache only magic-value-match and explicit mismatch outcomes. |
