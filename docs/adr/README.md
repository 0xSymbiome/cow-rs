...
| [0007](0007-bounded-browser-wallet-support-and-current-browser-runtime-contract.md) | Superseded by [0039](0039-typescript-callable-wasm-sdk-surface.md) and [0040](0040-wallet-provider-callback-boundary-for-js-consumers.md) | Retired bounded native browser-wallet posture; browser/wallet integration now served by `cow-sdk-wasm` plus the host wallet stack. |
...
| [0009](0009-wasm-verification-consoles-hybrid-extensibility-and-two-tier-proof.md) | Superseded by [0039](0039-typescript-callable-wasm-sdk-surface.md) | Kept WASM examples as named verification consoles; genre retired in favour of the `cow-sdk-wasm` surface plus host wallet stack. |
