...
additive capability per ADR 0001
...
edge against `cow-sdk-trading` keeps cow-shed an additive peer leaf per ADR 0001.
...
- Validation: the COW Shed contract-bindings audit cross-links this ADR and
  stays `Current` when the surface moves.
