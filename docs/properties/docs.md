...
Documentation and audit-lane governance: doc-agreement gates, the curated facade documentation, and the two named audit-lane docs covering the panic-free public surface and workflow-security contracts. Part of the [Properties Registry](index.md): 5 invariant(s), 4 covered.
...
| `PROP-DOCS-004` | whole workspace | `SECURITY.md` documents the base-URL override threat surface with operator-side mitigations. | Contract | Partial | `SECURITY.md` | 2026-06-16 |
