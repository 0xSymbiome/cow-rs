...
| `cow-sdk-trading` | Quote, post, allowance, approval, cancellation, slippage monotonicity and boundary clamping, calldata boundary preservation, quote-request override precedence, quote-to-order orchestration, order-id collision retry, receiver fallback, typed partner-fee public inputs and app-data merge-through, balance-semantics preservation, ready-versus-helper-only `TradingSdk` construction, helper-specific prerequisite resolution, and recoverable-signature owner or signer validation | `property_contract.rs`, `quote_contract.rs`, `post_contract.rs`, `order_contract.rs`, `allowance_contract.rs`, `cancel_contract.rs`, `onchain_contract.rs`, `slippage_contract.rs`, `sdk_contract.rs`, `parity_contract.rs`, `ui.rs`, `docs/audit/trading-order-construction-integrity-audit.md`, `docs/audit/trading-sdk-runtime-prerequisites-audit.md`, `docs/audit/trading-app-data-merge-audit.md`, `docs/audit/credential-surface-contract-hygiene-audit.md` | `cargo test -p cow-sdk-trading` |
...
| `cow-sdk` | Thin facade exports, curated prelude, feature-scoped public crate surface, and named-module re-export reachability | `public_api.rs`, `public_api_default_features_only.rs`, `public_api_with_all_features.rs`, `tests/fixtures/public_api_default_features_only.snap`, `tests/fixtures/public_api_with_all_features.snap`, `tests/ui/orderbook_client_reachable_through_trading_re_export.rs` | `cargo test -p cow-sdk` |
