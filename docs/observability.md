...
```toml
[dependencies]
cow-sdk = { version = "0.1.0-alpha.4", features = ["tracing"] }
# or, reaching individual crates directly:
cow-sdk-trading = { version = "0.1.0-alpha.4", features = ["tracing"] }
cow-sdk-app-data = { version = "0.1.0-alpha.4", features = ["tracing"] }
cow-sdk-contracts = { version = "0.1.0-alpha.4", features = ["tracing"] }
cow-sdk-orderbook = { version = "0.1.0-alpha.4", features = ["tracing"] }
cow-sdk-subgraph = { version = "0.1.0-alpha.4", features = ["tracing"] }
cow-sdk-signing = { version = "0.1.0-alpha.4", features = ["tracing"] }
cow-sdk-core = { version = "0.1.0-alpha.4", features = ["tracing"] }
```
