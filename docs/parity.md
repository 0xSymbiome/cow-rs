...
| Deployment registry authority | `cowprotocol/contracts` deployments record | `cow-sdk-contracts::Registry` const table | `crates/contracts/src/deployments/registry.rs` | `crates/contracts/src/deployments/registry.rs (tests)`, `scripts/validation-smoke/tests/registry_confirm.rs` |
