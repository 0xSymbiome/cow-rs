...
| EIP-712 domain separator | `alloy_sol_types::Eip712Domain::separator()` | `cow-sdk-signing`, `cow-sdk-contracts` | ADR 0052 | Bridged from cow `TypedDataDomain` via `into_alloy_domain()` (Bucket 2). |
