...
> **Branch:** `feat/ferrous-foundation` &nbsp;&middot;&nbsp; **HEAD:** `bcc1d0e` &nbsp;&middot;&nbsp; **Generated:** 2026-06-06  
...
- **39,359 lines of Rust** across the 20 SDK crates, covered by **42,888 lines of tests** — a **1.1× test-to-code ratio** — plus **180 lines of benchmarks**.
...
|------|------:|------:|-----:|---------|
| `crates/` | 756 | 140,229 | 98,255 | Workspace member crates (the SDK itself) |
...
|-----------|------:|------:|-----:|---------:|------:|--------------|
| `.rs` | 676 | 129,771 | 99,561 | 18,258 | 11,952 | Rust source and tests |
...
| `.yamllint` | 1 | 7 | 0 | 6 | 1 |  |
| **Total** | **1238** | **236,890** | **134,120** | **78,935** | **23,835** | |
...
| [`orderbook`](crates/orderbook) | 43 | 4,257 | 5,185 | 14 | 1,664 | 1.2× | Typed CoW Protocol orderbook client models and decoding helpers |
...
| **Total** | **756** | **39,359** | **42,888** | **180** | **12,663** | **1.1×** | |
