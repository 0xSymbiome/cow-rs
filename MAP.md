...
> **Branch:** `feat/ferrous-foundation` &nbsp;&middot;&nbsp; **HEAD:** `ae36f62` &nbsp;&middot;&nbsp; **Generated:** 2026-06-06  
...
- **39,359 lines of Rust** across the 20 SDK crates, covered by **43,130 lines of tests** — a **1.1× test-to-code ratio** — plus **180 lines of benchmarks**.
...
|------|------:|------:|-----:|---------|
| `crates/` | 756 | 140,486 | 98,497 | Workspace member crates (the SDK itself) |
...
|-----------|------:|------:|-----:|---------:|------:|--------------|
| `.rs` | 676 | 130,028 | 99,803 | 18,251 | 11,974 | Rust source and tests |
...
| `.yamllint` | 1 | 7 | 0 | 6 | 1 |  |
| **Total** | **1238** | **237,147** | **134,362** | **78,928** | **23,857** | |
...
| [`orderbook`](crates/orderbook) | 43 | 4,257 | 5,427 | 14 | 1,664 | 1.3× | Typed CoW Protocol orderbook client models and decoding helpers |
...
| **Total** | **756** | **39,359** | **43,130** | **180** | **12,663** | **1.1×** | |
