# cow-sdk-alloy-provider (reserved)

This crate name is reserved for the alloy-rs provider adapter of the
...
When published as `0.1.0` or later, this crate will provide an adapter
that implements the cow-sdk-core runtime trait contracts over the
alloy Rust web3 library.
