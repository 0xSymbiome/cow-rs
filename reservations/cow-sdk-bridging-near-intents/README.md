# cow-sdk-bridging-near-intents (reserved)

This crate name is reserved for the Near Intents bridge provider of the
...
When published as `0.1.0` or later, this crate will provide a
receiver-account-based Near Intents bridge provider including quote
and status integration, receiver-account handling, deposit-address
attestation checks, and non-EVM recipient logic.
