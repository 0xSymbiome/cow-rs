# cow-sdk-weiroll (reserved)

This crate name is reserved for the Weiroll script planner of the
...
transport-free Weiroll planner with command-graph construction,
ABI-aware encoding helpers, and script composition utilities.
