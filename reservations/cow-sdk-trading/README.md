# cow-sdk-trading (reserved)

This crate name is reserved for the high-level trading orchestration
of the [CoW Protocol Rust SDK](https://github.com/0xSymbiome/cow-rs),
...
When published as `0.1.0` or later, this crate will provide the
high-level TradingSdk that composes quote, sign, submit, and status
flows over the core, orderbook, signing, and contracts crates.
