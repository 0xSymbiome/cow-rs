# cow-sdk-contracts (reserved)

This crate name is reserved for the low-level contracts helpers of
the [CoW Protocol Rust SDK](https://github.com/0xSymbiome/cow-rs),
...
When published as `0.1.0` or later, this crate will provide hashing,
settlement calldata encoding, and on-chain interaction plumbing for
the CoW Protocol settlement and vault-relayer contracts.
