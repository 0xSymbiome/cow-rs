# cow-sdk-bridging-bungee (reserved)

This crate name is reserved for the Bungee (Socket) bridge provider of
...
hook-based Bungee (Socket) bridge provider including API DTOs, quote
and status handling, and transaction-build verification.
