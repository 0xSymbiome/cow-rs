# cow-sdk-subgraph (reserved)

This crate name is reserved for the subgraph GraphQL client of the
...
When published as `0.1.0` or later, this crate will provide typed
GraphQL access to the CoW Protocol subgraph for historical order,
trade, and volume queries.
