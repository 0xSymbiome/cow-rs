# cow-sdk-cow-shed (reserved)

This crate name is reserved for the CoW Shed smart-account proxy
integration of the
...
deterministic CoW Shed proxy derivation, typed-data pre-authorization
flows, hook execution calldata encoding, and EIP-1271-aware
smart-account paths.
