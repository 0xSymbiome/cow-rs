# cow-sdk-flash-loans (reserved)

This crate name is reserved for the flash-loan orchestration helpers of
...
flash-loan-specific orchestration above the trading layer, including
Aave-first integration for collateral swap, debt swap, and
repay-with-collateral flows.
