# cow-sdk-bridging (reserved)

This crate name is reserved for the bridging domain and orchestration
core of the
...
`BridgingSdk`-level orchestration, bridge domain types, hook-based
provider traits, receiver-account-provider traits, quote strategies,
and cross-chain order monitoring.
