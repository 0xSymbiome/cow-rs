# cow-sdk-transport-policy (reserved)

This crate name is reserved for the retry, rate-limit, and transport
classification policy of the
...
When published as `0.1.0` or later, this crate will provide the retry,
rate-limit, and transport error classification policy shared by the CoW
Protocol SDK's HTTP clients.
