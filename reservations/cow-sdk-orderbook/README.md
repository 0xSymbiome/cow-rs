# cow-sdk-orderbook (reserved)

This crate name is reserved for the orderbook REST client of the
...
When published as `0.1.0` or later, this crate will provide a typed
async REST client for the CoW Protocol orderbook service, covering
quote, order submission, status, and trade history endpoints.
