# cow-sdk-bridging-across (reserved)

This crate name is reserved for the Across bridge provider of the
...
hook-based Across bridge provider including API DTOs, quote and status
logic, and deposit-path construction.
