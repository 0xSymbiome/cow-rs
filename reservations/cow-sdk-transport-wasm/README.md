# cow-sdk-transport-wasm (reserved)

This crate name is reserved for the browser fetch-based HTTP transport
of the
...
When published as `0.1.0` or later, this crate will provide a browser
fetch-based HTTP transport implementation for the CoW Protocol SDK
