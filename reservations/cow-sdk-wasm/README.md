# cow-sdk-wasm (reserved)

This crate name is reserved for the TypeScript-callable wasm-bindgen
leaf of the
...
TypeScript-callable wasm-bindgen entry point that compiles the CoW
Protocol SDK to WebAssembly for use from JavaScript and TypeScript.
