...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_3816: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_3824: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_849: (a: number, b: number, c: number) => number;
    readonly __wasm_bindgen_func_elem_3741: (a: number, b: number) => void;
