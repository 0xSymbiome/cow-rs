...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_4392: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4400: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_904: (a: number, b: number, c: number) => number;
    readonly __wasm_bindgen_func_elem_3995: (a: number, b: number) => void;
