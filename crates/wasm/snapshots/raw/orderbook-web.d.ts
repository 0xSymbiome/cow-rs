...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_4635: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4643: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1036: (a: number, b: number, c: number) => number;
    readonly __wasm_bindgen_func_elem_4238: (a: number, b: number) => void;
