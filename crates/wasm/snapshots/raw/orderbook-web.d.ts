...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_3822: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_3830: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_855: (a: number, b: number, c: number) => number;
    readonly __wasm_bindgen_func_elem_3747: (a: number, b: number) => void;
