...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_12467: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_12475: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1336: (a: number, b: number, c: number) => number;
