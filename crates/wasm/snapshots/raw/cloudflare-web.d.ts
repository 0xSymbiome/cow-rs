...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_11818: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_11826: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1171: (a: number, b: number, c: number) => number;
    readonly __wasm_bindgen_func_elem_11445: (a: number, b: number) => void;
