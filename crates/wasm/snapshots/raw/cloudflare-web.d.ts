...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_11178: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1174: (a: number, b: number, c: number) => number;
