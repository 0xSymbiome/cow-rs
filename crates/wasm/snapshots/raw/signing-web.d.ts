...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_2209: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2217: (a: number, b: number, c: number, d: number) => void;
