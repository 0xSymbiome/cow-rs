...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_2360: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2368: (a: number, b: number, c: number, d: number) => void;
