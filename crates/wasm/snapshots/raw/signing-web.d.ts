...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_2208: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2216: (a: number, b: number, c: number, d: number) => void;
