...
exports.FetchCallbackHandle = FetchCallbackHandle;

/**
 * Adapter that lets app-data IPFS reads flow through an HTTP transport.
 */
class HttpToIpfsAdapter {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
...
exports.HttpToIpfsAdapter = HttpToIpfsAdapter;
...
exports.IpfsClientWithFetch = IpfsClientWithFetch;
 ...
 */
class OrderBookClientWithFetch {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
...
exports.OrderBookClientWithFetch = OrderBookClientWithFetch;
...
exports.SubgraphClientWithFetch = SubgraphClientWithFetch;
...
exports.TradingClientWithFetch = TradingClientWithFetch;
 ...
 * @returns {string}
 */
function appDataHexToCid(app_data_hex) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {any}
 */
function computeOrderUid(input, chain_id, owner) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(owner, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {any}
 */
function deploymentAddresses(chain_id, env) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = isLikeNone(env) ? 0 : passStringToWasm0(env, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        var len0 = WASM_VECTOR_LEN;
 ...
 * @returns {string}
 */
function domainSeparator(chain_id) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {string}
 */
function eip1271SignaturePayload(input, ecdsa_signature) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {Promise<any>}
 */
function fetchAppDataFromCid(cid, ipfs_uri, timeout_ms) {
    const ptr0 = passStringToWasm0(cid, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(ipfs_uri) ? 0 : passStringToWasm0(ipfs_uri, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    var len1 = WASM_VECTOR_LEN;
...
exports.fetchAppDataFromCid = fetchAppDataFromCid;
 ...
 * @returns {Promise<any>}
 */
function fetchAppDataFromHex(app_data_hex, ipfs_uri, timeout_ms) {
    const ptr0 = passStringToWasm0(app_data_hex, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(ipfs_uri) ? 0 : passStringToWasm0(ipfs_uri, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    var len1 = WASM_VECTOR_LEN;
...
exports.fetchAppDataFromHex = fetchAppDataFromHex;
 ...
 * @returns {any}
 */
function orderTypedData(input, chain_id) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 */
function registerFetchCallback(callback) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.registerFetchCallback = registerFetchCallback;
 ...
 * @returns {Promise<any>}
 */
function signCancellationEthSignDigest(order_uids, chain_id, digest_signer) {
 ...
 * @returns {Promise<any>}
 */
function signCancellationWithEip1193(order_uids, chain_id, owner, request_callback) {
    const ptr0 = passArrayJsValueToWasm0(order_uids, wasm.__wbindgen_export);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Promise<any>}
 */
function signCancellationWithTypedDataSigner(order_uids, chain_id, typed_data_signer) {
    const ptr0 = passArrayJsValueToWasm0(order_uids, wasm.__wbindgen_export);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Promise<any>}
 */
function signOrderEthSignDigest(input, chain_id, owner, digest_signer) {
    const ptr0 = passStringToWasm0(owner, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Promise<any>}
 */
function signOrderWithCustomEip1271(input, chain_id, owner, custom_callback) {
    const ptr0 = passStringToWasm0(owner, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Promise<any>}
 */
function signOrderWithEip1193(input, chain_id, owner, request_callback) {
    const ptr0 = passStringToWasm0(owner, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Promise<any>}
 */
function signOrderWithEip1271(input, chain_id, owner, typed_data_signer) {
    const ptr0 = passStringToWasm0(owner, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Promise<any>}
 */
function signOrderWithTypedDataSigner(input, chain_id, owner, typed_data_signer) {
    const ptr0 = passStringToWasm0(owner, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
