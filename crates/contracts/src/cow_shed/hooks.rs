...
use crate::cow_shed::calls::encode_execute_hooks_calldata_signed;
use crate::cow_shed::eip712::execute_hooks_typed_data_payload;
use crate::cow_shed::errors::CowShedError;
use crate::cow_shed::types::Call;
use crate::cow_shed::version::CowShedVersion;
...
impl CowShedHooks {
    ...
    /// `crate::verify_eip1271_signature_cached` helper before
