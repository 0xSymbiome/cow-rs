...
> selects it only when you opt in (`cow-sdk-alloy-signer = "0.1.0-alpha.4"`).
...
```toml
[dependencies]
cow-sdk-alloy-signer = "0.1.0-alpha.4"
```
...
```toml
[dependencies]
cow-sdk-alloy-signer = { version = "0.1.0-alpha.4", default-features = false }
```
