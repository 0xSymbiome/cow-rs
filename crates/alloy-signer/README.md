...
> selects it only when you opt in (`cow-sdk-alloy-signer = "0.1.0-alpha.10"`).
...
```toml
[dependencies]
cow-sdk-alloy-signer = "0.1.0-alpha.10"
```
...
```toml
[dependencies]
cow-sdk-alloy-signer = { version = "0.1.0-alpha.10", default-features = false }
```
