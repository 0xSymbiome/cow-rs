...
#[cfg(not(target_arch = "wasm32"))]
pub fn host_app_data_input() -> cow_sdk_js::helpers::dto::AppDataParams {
    cow_sdk_js::helpers::dto::AppDataParams {
...
#[cfg(target_arch = "wasm32")]
pub fn wasm_app_data_input() -> cow_sdk_js::exports::AppDataParams {
    cow_sdk_js::exports::AppDataParams {
        app_code: "CoW Swap".to_owned(),
        metadata: serde_json::json!({}),
        version: "0.7.0".to_owned(),
        environment: None,
...
) -> cow_sdk_js::exports::OrderBookClientConfig {
...
pub fn subgraph_config(
    ...
    api_key: &str,
    callback: &js_sys::Function,
) -> cow_sdk_js::exports::SubgraphClientConfig {
    let config = js_sys::Object::new();
    set_js(
        &config,
        "chainId",
...
pub fn trading_config(
    ...
    app_code: &str,
    callback: &js_sys::Function,
) -> cow_sdk_js::exports::TradingClientConfig {
    let config = js_sys::Object::new();
    set_js(
        &config,
        "chainId",
...
pub fn ipfs_config(
    ...
    callback: &js_sys::Function,
) -> cow_sdk_js::exports::IpfsClientConfig {
    let config = js_sys::Object::new();
