 ...
 */
export interface TwapCreateResult {
    /**
 ...
 */
export function buildAppData(appCode: string, slippageBps: number, orderClass: string): WasmEnvelope<AppDataInfo>;
 ...
 */
export function buildTwapCreateTransaction(params: TwapCreateParams): WasmEnvelope<TwapCreateResult>;
 ...
 */
export function buildTwapRemoveTransaction(orderId: string): WasmEnvelope<TransactionRequest>;
