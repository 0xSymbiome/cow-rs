...
export declare class TradingClient {
    ...
    placeSwap(quoteResults: raw.QuoteResults, owner: string, auth: raw.Authorization, options?: SigningOptions | null): Promise<WasmEnvelope<raw.OrderPlacement>>;
    placeLimit(params: raw.LimitTradeParams, owner: string, auth: raw.Authorization, options?: SigningOptions | null): Promise<WasmEnvelope<raw.OrderPlacement>>;
    buildPresignActivationTransaction(params: raw.PresignActivationParams): WasmEnvelope<raw.SafeActivation>;
    dispose(): void;
    [Symbol.dispose](): void;
}
...
export type { AllowanceParams, Amounts, AppDataDocument, AppDataParams, AppDataInfo, AppDataObject, ApprovalParams, Authorization, BuiltSellNativeCurrencyTx, BuyTokenDestination, CompetitionAuction, CompetitionOrderStatus, CompetitionOrderStatusKind, ContractCall, Costs, CowEip1271SignRequest, DeploymentAddresses, EthflowData, EthFlowEvent, EventLog, ExecutedAmounts, ExecutedProtocolFee, FeeComponent, GeneratedOrderUid, InitInput, InteractionData, LimitTradeParams, NativePriceResponse, NetworkFee, OnchainOrderData, Order, OrderData, OrderbookBinding, OrderClass, OrderCreation, OrderInteractions, OrderKind, OrderPlacement, OrderPostingResult, OrderQuoteRequest, OrderQuoteResponse, OrderStatus, OrderTraderParams, PaginationOptions, PartnerFee, PartnerFeePolicy, PresignActivationParams, QuoteAmountsAndCosts, QuoteData, QuoteResults, SafeActivation, SellTokenSource, SettlementEvent, SignedCancellations, SignedOrder, SigningScheme, SolverCompetitionOrder, SolverCompetitionResponse, SolverExecution, SolverSettlement, StoredOrderQuote, TotalSurplus, Trade, TradeParams, GetTradesRequest, TradingAppDataInfo, TransactionRequest, TwapCreateParams, TwapCreateResult, TypedDataDomain, TypedDataEnvelope, TypedDataField, ValidationResult, WrappedNativeToken } from "./raw/trading.js";
